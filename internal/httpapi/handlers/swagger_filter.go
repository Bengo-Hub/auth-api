...
// (components, info, openapi, servers, security, tags) passes through unchanged so $ref lookups
// and the spec's own metadata stay valid for whatever's left. Mirrors treasury-api's
// internal/http/handlers/swagger_filter.go verbatim -- same shape of problem, no reason to diverge.
