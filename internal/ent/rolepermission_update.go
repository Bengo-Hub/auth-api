...
func (_u *RolePermissionUpdate) SetRoleName(v string) *RolePermissionUpdate {
	_u.mutation.SetRoleName(v)
	return _u
}

// SetNillableRoleName sets the "role_name" field if the given value is not nil.
func (_u *RolePermissionUpdate) SetNillableRoleName(v *string) *RolePermissionUpdate {
	if v != nil {
		_u.SetRoleName(*v)
	}
	return _u
...
// SetRoleName sets the "role_name" field.
func (_u *RolePermissionUpdateOne) SetRoleName(v string) *RolePermissionUpdateOne {
	_u.mutation.SetRoleName(v)
	return _u
}

// SetNillableRoleName sets the "role_name" field if the given value is not nil.
func (_u *RolePermissionUpdateOne) SetNillableRoleName(v *string) *RolePermissionUpdateOne {
	if v != nil {
		_u.SetRoleName(*v)
	}
	return _u
