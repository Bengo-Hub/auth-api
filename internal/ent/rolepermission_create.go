...
func (_c *RolePermissionCreate) SetRoleName(v string) *RolePermissionCreate {
...
func (_c *RolePermissionCreate) check() error {
	if _, ok := _c.mutation.RoleName(); !ok {
		return &ValidationError{Name: "role_name", err: errors.New(`ent: missing required field "RolePermission.role_name"`)}
	}
	if v, ok := _c.mutation.RoleName(); ok {
		if err := rolepermission.RoleNameValidator(v); err != nil {
			return &ValidationError{Name: "role_name", err: fmt.Errorf(`ent: validator failed for field "RolePermission.role_name": %w`, err)}
		}
	}
...
func (_c *RolePermissionCreate) createSpec() (*RolePermission, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.RoleName(); ok {
		_spec.SetField(rolepermission.FieldRoleName, field.TypeString, value)
...
// SetRoleName sets the "role_name" field.
func (u *RolePermissionUpsert) SetRoleName(v string) *RolePermissionUpsert {
	u.Set(rolepermission.FieldRoleName, v)
	return u
}

// UpdateRoleName sets the "role_name" field to the value that was provided on create.
func (u *RolePermissionUpsert) UpdateRoleName() *RolePermissionUpsert {
	u.SetExcluded(rolepermission.FieldRoleName)
	return u
}
...
// SetRoleName sets the "role_name" field.
func (u *RolePermissionUpsertOne) SetRoleName(v string) *RolePermissionUpsertOne {
...
// UpdateRoleName sets the "role_name" field to the value that was provided on create.
func (u *RolePermissionUpsertOne) UpdateRoleName() *RolePermissionUpsertOne {
	return u.Update(func(s *RolePermissionUpsert) {
		s.UpdateRoleName()
	})
}
...
// SetRoleName sets the "role_name" field.
func (u *RolePermissionUpsertBulk) SetRoleName(v string) *RolePermissionUpsertBulk {
	return u.Update(func(s *RolePermissionUpsert) {
		s.SetRoleName(v)
	})
}
...
// UpdateRoleName sets the "role_name" field to the value that was provided on create.
func (u *RolePermissionUpsertBulk) UpdateRoleName() *RolePermissionUpsertBulk {
	return u.Update(func(s *RolePermissionUpsert) {
		s.UpdateRoleName()
	})
}
