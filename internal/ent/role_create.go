...
func (u *RoleUpsert) ClearScope() *RoleUpsert {
	u.SetNull(role.FieldScope)
	return u
}
...
// ClearScope clears the value of the "scope" field.
func (u *RoleUpsertOne) ClearScope() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.ClearScope()
	})
}
...
// ClearScope clears the value of the "scope" field.
func (u *RoleUpsertBulk) ClearScope() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.ClearScope()
	})
}
