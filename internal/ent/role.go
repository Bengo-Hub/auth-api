...
type Role struct {
	...
	// Stable identifier; equals RolePermission.role_name and TenantMembership.roles[] values.
	RoleCode string `json:"role_code,omitempty"`
	// Human-readable display name.
	Name string `json:"name,omitempty"`
	// Optional description of what the role grants.
	Description string `json:"description,omitempty"`
	// System roles cannot be edited or deleted via the admin API.
	IsSystem bool `json:"is_system,omitempty"`
	// Inferred scope grouping e.g. platform, erp, pos, logistics, ordering.
...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case role.FieldRoleCode, role.FieldName, role.FieldDescription, role.FieldScope:
