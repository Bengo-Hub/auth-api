...
func ScopeIsNil() predicate.Role {
	return predicate.Role(sql.FieldIsNull(FieldScope))
}

// ScopeNotNil applies the NotNil predicate on the "scope" field.
func ScopeNotNil() predicate.Role {
	return predicate.Role(sql.FieldNotNull(FieldScope))
}
