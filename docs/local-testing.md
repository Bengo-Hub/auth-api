...
The seed creates user `admin@codevertexafrica.com` with role `superuser` in tenant `codevertex`.
...
- Login: `POST /api/v1/auth/login` with `{ "email":"admin@codevertexafrica.com","password":"ChangeMe123!","tenant_slug":"codevertex" }`
